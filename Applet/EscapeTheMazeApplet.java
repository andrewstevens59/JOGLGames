...
public class EscapeTheMazeApplet extends Applet implements MouseListener, MouseMotionListener   {

    public static int WIDTH = 800;
    
    private EscapeTheMaze tr = null;
